...
import type { NavigationTree } from "../navigation_tree.js";
import type { ExpandController } from "./expand_controller.js";
export interface TreeIntegrationOptions {
  wrapper: HTMLElement;
  gooContainer: HTMLElement;
  navigationTree: NavigationTree;
  expandController: ExpandController;
  /** The ball's resting `right` offset, px, to restore on close. */
  ballOriginalRight: number;
}

export class TreeIntegration {
  wrapper: TreeIntegrationOptions["wrapper"];
  gooContainer: TreeIntegrationOptions["gooContainer"];
  navigationTree: TreeIntegrationOptions["navigationTree"];
  expandController: TreeIntegrationOptions["expandController"];
  ballOriginalRight: TreeIntegrationOptions["ballOriginalRight"];
  isOpen: boolean;
  ballTreeOpenRight: number | null;
