...
/** One outline section, marked on the progress bar. */
export interface SectionMark {
  title: string;
  /** Normalized position (0-1) in document. */
  position: number;
  element: HTMLElement;
  reached: boolean;
}
...
export class ProgressBar {
  ...
  glowLine: HTMLDivElement | null;
  progressIndicator: HTMLDivElement | null;
  sectionsContainer: HTMLDivElement | null;
  sectionMarks: SectionMark[];
  currentProgress: number;
  lastReachedSectionIndex: number;
  isSplitMode: boolean;
  ...
  #previousPane: ViewerPane | null = null;
  ...
  #celebrateSection(section: SectionMark) {
