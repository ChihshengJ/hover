...
export class ToolButtonTooltip {
  ...
  _tipTitle: HTMLElement | null;
  _tipDesc: HTMLElement | null;
  _tipShowTimer: ReturnType<typeof setTimeout> | null;
  _tipHideTimer: ReturnType<typeof setTimeout> | null;
  _tipVisible: boolean;

  /**
   * @param wrapper The floating-toolbar wrapper element.
   */
  ...
  attach() {
    ...
    for (const btn of this.wrapper.querySelectorAll<HTMLElement>(".tool-btn")) {
