...
// of the app shares these via src/platform/util/base64.js instead.
(function () {
  ...
  async function fetchAsPdfBase64(url: string): Promise<string | null> {
  ...
  async function findAndFetchPdf(
    pageUrl: string,
    ...
    try {
      ...
      ) as NodeListOf<HTMLEmbedElement>) {
